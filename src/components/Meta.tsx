  ...
  return (
    <div className="grid sm:grid-cols-2 justify-between mt-6 gap-x-10 gap-y-4">
      ...
      <MetaField
        ...
        name="Filière"
        placeholder="ex: SMI"
        onChange={(e: any) => updateMeta({ ...meta, filiere: e.target.value })}
      />
      <MetaField
        value={meta.session}
        name="Session"
        placeholder="ex: Automne 2021-2022"
        onChange={(e: any) => updateMeta({ ...meta, session: e.target.value })}
      />
      <MetaField
        value={meta.session}
        name="Module"
      ...
      <MetaField
        ...
        name="Durée"
        placeholder="ex: 1h"
        onChange={(e: any) => updateMeta({ ...meta, duree: e.target.value })}
      />
