...
\element{general}{
  \begin{questionmult}{Q001}
Question 1 :
%\begin{multicols}{2}
    \begin{reponses}   \bareme{formula=(NB==N?NBC:NBC+NMC==N ? 0 : NBC/2-NMC/2),p=0,e=0,v=0}
      \bonne{Bonne reponse}
      \bonne{Bonne reponse}
      \mauvaise{Mauvaise reponse 1}
      \mauvaise{Mauvaise reponse 2}
    \end{reponses}
%     \end{multicols}
  \end{questionmult}
  \vspace{2ex}
...
Question 2 :
%\begin{multicols}{2}
    \begin{reponses} \bareme{formula= NBC/2-NMC/2}
      \bonne{Bonne reponse}
      \mauvaise{Mauvaise reponse 1}
      \mauvaise{Mauvaise reponse 2}
      \mauvaise{Mauvaise reponse 3}
    \end{reponses}
%         \end{multicols}
  \end{question}
 \vspace{2ex}
...
\noindent{\bf \emph{Département de Biologie}  } \\

\vspace{2ex}

\noindent{\bf \emph{Filière :  }  } \\

\vspace{2ex}

\noindent{\bf \emph{Session : Automne 2017-2018  }  } \\

\vspace{2ex}

\noindent{\bf \emph{Module :   }  } \\

\vspace{2ex}

\noindent{\bf Durée : 90 minutes } \\
\end{center}
